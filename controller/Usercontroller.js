...
const Mobiles = async (req, res) => {
  try {
    const data = await Product.find({category:"mobile"})
...
const Watches = async (req, res) => {
  try {
    const data = await Product.find({category:"watch"})
...
const Laptop = async (req, res) => {
  try {
    const data = await Product.find({category:"laptop"})
...
const Headset = async (req, res) => {
  try {
    const data = await Product.find({category:"headset"})
...
const details= await user.findOne({email:userEmail})
