...
const mobile = db.collection("Mobile");
const watch = db.collection("Watch");
const headset = db.collection("Headset");
const laptop = db.collection("Laptop");
const Mobiles = async (req, res) => {
  try {
    const data = await mobile.find({}).toArray();
  ...
  // res.send(MobilesData);
};
const Watches = async (req, res) => {
  try {
    const data = await watch.find({}).toArray();
...
const Laptop = async (req, res) => {
  try {
    const data = await laptop.find({}).toArray();
...
const Headset = async (req, res) => {
  try {
    const data = await headset.find({}).toArray();
    console.log("headset Data", data);
    return res.send(data);
  } catch (err) {
    console.log({ error: err });
    return res.send({ error: err });
...
const Addproduct = async (req, res) => {
  try {
    await mobile.insertMany([
      {
        product_tittle: "vivo T2x 5G(Aura Gold ,128GB)",
        image:
      ...
      },
      {
        ...
        image:
          "https://rukminim2.flixcart.com/image/312/312/xif0q/mobile/d/n/k/v27-5g-pd2269-v2246-vivo-original-imagpv82geyhzfze.jpeg?q=70",
        price:39998,
        highlights:
          "With the superb Vivo Y56 5G, you can take advantage of great pictures and a flawless user experience. With the Vivo T2x 5G, you can experience exceptional performance owing to its 7 nm 5G CPU, the octa-core Dimensity 6020, with a top clock speed of 2.2 GHz. Additionally, the 50 MP main camera on this smartphone beautifully catches every detail you see. Additionally, Super Night Selfie employs noise cancellation technology in conjunction with an Aura Screen Light to produce a calming light that is effective in low light. The pioneering Extended RAM 3.0 technology also uses ROM to expand RAM with a maximum capacity of 8 GB. This enables smooth app switching and allows up to 27 active applications to run in the background.",
        category: "vivo",
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/81X85GWtYHL._AC_UY327_FMwebp_QL65_.jpg",
        price:12999,
        highlights:`About this item
        Processor: Octa-core MediaTek Helio G96 gaming processor clocked at 2.05GHz for excellent gaming performance along with a powerful Mali-G57 MC2 GPU.
        Display: 6.6 inch FHD+ (2412x1080) display comes with an ultra-smooth 120Hz high refresh rate display and a 90.8% Screen-to-body ratio
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/71YSPlNJN7L._AC_UY327_FMwebp_QL65_.jpg",
        price:9999,
        highlights:`About this item
    ...
    await laptop.insertMany([
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/618gNo+ohxL._AC_UY327_FMwebp_QL65_.jpg",
        price:199900,
        highlights:`About this item
        SUPERCHARGED BY M2 PRO OR M2 MAX — Take on demanding projects with the M2 Pro or M2 Max chip. M2 Pro has up to 12 CPU cores, up to 19 GPU cores and up to 32GB unified memory. M2 Max has 12 CPU cores, up to 38 GPU cores and up to 96GB unified memory.
        UP TO 18 HOURS OF BATTERY LIFE — Go all day thanks to the power-efficient design of the M2 Pro or M2 Max chip. And MacBook Pro delivers exceptional performance whether it’s running on battery or plugged in.
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/512QAURU1TL._AC_UY327_FMwebp_QL65_.jpg",
        price:30990 ,
        highlights:`About this item
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/619wdC9vcCL._AC_UY327_FMwebp_QL65_.jpg",
        price:34990,
        highlights:`About this item
        Processor: 11th Gen Intel Core i3-1115G4 | Speed: 3.0 GHz (Base) - 4.1 GHz (Max) | 2 Cores | 4 Threads | 6MB Cache
        OS & Software: Windows 11 Home 64 | Office Home and Student 2021 | Xbox GamePass Ultimate 3-month subscription
    ...
    await watch.insertMany([
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61n4MZgN8mL._AC_UY327_FMwebp_QL65_.jpg",
        price:1099,
        highlights:`About this item
        1.38” TFT display: Featuring a vibrant round display and a stylish metallic finish, the smartwatch offers a premium on-screen experience.
        Tru SyncTM: Hassle-free pairing, stable connectivity and lower battery consumption combine to provide the most advanced calling experience.
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/71E-JtwkHkL._AC_UY327_FMwebp_QL65_.jpg",
        price:1099,
        highlights:`About this item
        1.38” TFT display: Featuring a vibrant round display and a stylish metallic finish, the smartwatch offers a premium on-screen experience.
        Tru SyncTM: Hassle-free pairing, stable connectivity and lower battery consumption combine to provide the most advanced calling experience.
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/618mFEP9mTL._AC_UY327_FMwebp_QL65_.jpg",
        price:1599,
        highlights:`About this item
        1.38” TFT display: Featuring a vibrant round display and a stylish metallic finish, the smartwatch offers a premium on-screen experience.
        Tru SyncTM: Hassle-free pairing, stable connectivity and lower battery consumption combine to provide the most advanced calling experience.
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61kNGage5AL._AC_UY327_FMwebp_QL65_.jpg",
        price:1199,
        highlights:`About this item
        1.38” TFT display: Featuring a vibrant round display and a stylish metallic finish, the smartwatch offers a premium on-screen experience.
        Tru SyncTM: Hassle-free pairing, stable connectivity and lower battery consumption combine to provide the most advanced calling experience.
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/714vvt0LLOL._AC_UY327_FMwebp_QL65_.jpg",
        price:1199,
        highlights:`About this item
        1.38” TFT display: Featuring a vibrant round display and a stylish metallic finish, the smartwatch offers a premium on-screen experience.
        Tru SyncTM: Hassle-free pairing, stable connectivity and lower battery consumption combine to provide the most advanced calling experience.
    ...
    await headset.insertMany([
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61l+14s5QVL._AC_UY327_FMwebp_QL65_.jpg",
        price:299,
        highlights:`About this item
        Playback- Airdopes Atom 81 offer a total playtime of up to 50HRS, including up to 10HRS of playtime per earbud.
        Clear Voice Calls- Be heard clear across voice calls without those usual interruptions, with the Quad Mics ENx Tech enabled Airdopes Atom 81, that cancels out unwanted background noises during calls.
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61fo5RouiZL._AC_UY327_FMwebp_QL65_.jpg",
        price:449,
        highlights:`About this item
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/51h4QPIyp3L._AC_UY327_FMwebp_QL65_.jpg",
        price:899,
        highlights:`About this item
        Innovative housing design enables for easy adjustment and optimal wearing comfort with powerful 10mm drivers for sonic clarity, bass-driven stereo sound and good attenuation of ambient noise
        The noise-cancelling microphone enables trouble free receiving of calls or undeterred sessions of musical extravaganza
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61dPCezxNaL._AC_UY327_FMwebp_QL65_.jpg",
        price:1999,
        highlights:`About this item
        Innovative housing design enables for easy adjustment and optimal wearing comfort with powerful 10mm drivers for sonic clarity, bass-driven stereo sound and good attenuation of ambient noise
        The noise-cancelling microphone enables trouble free receiving of calls or undeterred sessions of musical extravaganza
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61ihJqGvkML._AC_UY327_FMwebp_QL65_.jpg",
        price:1499,
        highlights:`About this item
        Product Design: MIVI DuoPods A850 TWS feature 'The Starry Night Effect' shimmer on the case & a stunning superior-grade Metallic finish on the pods.
        Call Clarity: The ear buds are powered by AI-ENC to eliminate environmental noise thus helping you deliver clear message on calls
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61nbQi6k5-L._AC_UY327_FMwebp_QL65_.jpg",
        price:1299,
        highlights:`About this item
        Product Design: MIVI DuoPods A850 TWS feature 'The Starry Night Effect' shimmer on the case & a stunning superior-grade Metallic finish on the pods.
        Call Clarity: The ear buds are powered by AI-ENC to eliminate environmental noise thus helping you deliver clear message on calls
      ...
      },
      {
        ...
        image:"https://m.media-amazon.com/images/I/61TmcMQHB+L._AC_UY327_FMwebp_QL65_.jpg",
        price:600,
        highlights:`About this item
        Product Design: MIVI DuoPods A850 TWS feature 'The Starry Night Effect' shimmer on the case & a stunning superior-grade Metallic finish on the pods.
        Call Clarity: The ear buds are powered by AI-ENC to eliminate environmental noise thus helping you deliver clear message on calls
...
const getcartdetails= async (req,res)=>{
  try{
    const user_email=req.email
const cartdetails=await cart.find({userEmail:user_email})
...
const details= await db.collection('Users').findOne({email:userEmail})
